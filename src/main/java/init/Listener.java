...
public class Listener implements ITestListener {
	...
	public void onTestSkipped(ITestResult res) {
		/*
		 * EventFiringWebDriver driver = null; try { driver = ((Init)
		 * res.getInstance()).getDriver(); } catch (Exception e) { e.printStackTrace();
		 * } ExtentTest test = Init.report.startTest(res.getName()); if (driver != null)
		 * { test.log(LogStatus.SKIP, res.getName()); test.log(LogStatus.SKIP,
		 * res.getThrowable()); } Init.endTest();
		 */
