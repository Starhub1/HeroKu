...
public class MouseHover extends Init {
	...
	public void verifyMouseHoverFunctionality() throws Exception {
		...
		logger.log(Status.PASS, "On Mouse Hover of user1 the user name of the user is " + mouseHoverOnUserImage.getUserNameonMouseHover(1));
		logger.log(Status.PASS, "On Mouse Hover of user1 the Profile link text of the user is " + mouseHoverOnUserImage.getViewProfileLinktext(1));
