...
public class DatePicker extends Init {
	...
	public void VerifySelectADate() throws Exception {
		...
		ExtentTest logger = Init.setLogger("Select JQuery Date").assignAuthor("Mohammed Nasir")
	...
	public void verifyheaderoftheDatePickerPage() throws Exception {
		System.out.println("Test - The thread id is" + Thread.currentThread().getId());
		ExtentTest logger = setLogger("Verify header of the Date Picker Page.").assignAuthor("Mohammed Nasir")
				.assignCategory("Category Regression");
