...
public class ContextMenu extends Init {
	...
	public void VerifyContextMenuFunctionality() throws Exception {
		...
		ExtentTest logger = setLogger("Verify ContextMenu Functionality").assignAuthor("Mohammed Nasir")
	...
	public void verifyheaderoftheContextMenuPage() throws Exception {
		System.out.println("Test - The thread id is" + Thread.currentThread().getId());
		ExtentTest logger = setLogger("Verigy the header of the context Menu page.").assignAuthor("Mohammed Nasir")
				.assignCategory("Category Regression");
